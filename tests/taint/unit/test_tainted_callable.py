...
class TestTaintedCallable:
    ...
    def test_class_method(self):
        ...
        tainted_method = TaintedCallable(MockCallableClass.class_method, taint_origin="class_method_test")
    ...
    def test_static_method(self):
        ...
        tainted_method = TaintedCallable(MockCallableClass.static_method, taint_origin="static_test")
    ...
    def test_multiple_taint_origins(self):
        ...
        tainted_func = TaintedCallable(
            sample_function, 
            taint_origin=["origin1", "origin2", "origin3"]
        )
