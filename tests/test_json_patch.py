...
"""
Test all json module functions for taint propagation using develop launcher.
"""
...
launcher = DevelopTestLauncher("test_json_patch")

# Create pytest functions using the shared framework
pytest_functions = create_pytest_functions("test_json_patch", launcher)
