...
def main():
    ...
    parser.add_argument(
        "--data_path", type=str, required=True, help="Path to BIRD dataset JSON file"
    )
    parser.add_argument(
        "--db_root_path", type=str, required=True, help="Root path to BIRD databases"
    )
    parser.add_argument(
        "--output_path", type=str, required=True, help="Output directory for predictions"
    )
    parser.add_argument(
        "--mode",
        type=str,
