...
::: aco.server.file_watcher.rewrite_source_to_code
    options:
...
::: aco.server.ast_helpers.exec_func
    options:
      show_root_heading: true
      show_source: true
...
::: aco.server.ast_helpers.taint_fstring_join
    options:
      show_root_heading: true
      show_source: true
...
::: aco.server.ast_helpers.taint_format_string
    options:
      show_root_heading: true
      show_source: true
...
::: aco.server.ast_helpers.taint_percent_format
    options:
      show_root_heading: true
      show_source: true
...
::: aco.server.file_watcher.is_pyc_rewritten
    options:
      show_root_heading: true
      show_source: true
